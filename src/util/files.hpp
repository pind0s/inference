...
// https://github.com/es3n1n/common/blob/master/include/es3n1n/common/files.hpp
namespace util {
    ...
    inline void write_file(const std::filesystem::path& path, const std::uint8_t* raw_buffer,
